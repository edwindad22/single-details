    ...
    <>
            ...
            {gifts.map((gift) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="w-12 h-12 rounded-full bg-white dark:bg-[#241520] border border-blush dark:border-[#4A1E30] flex items-center justify-center flex-shrink-0 shadow-sm">
                ...
                <p className="font-sans text-sm text-warm-muted dark:text-[#E8A0B0] leading-relaxed">{gift.desc}</p>
              </div>
            ))}
          </div>

          <div className="bg-cream-dark dark:bg-[#241520] rounded-2xl p-6 text-center mb-12">
      ...
      <section className="bg-transparent dark:bg-[#140A0E] py-16 px-4 sm:px-6">
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white dark:bg-[#241520] rounded-3xl p-8 shadow-2xl">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="bg-white dark:bg-[#241520] rounded-2xl border border-blush dark:border-[#4A1E30] p-7 flex flex-col gap-4"
              >
                ...
                <p className="font-serif text-warm-muted dark:text-[#E8A0B0] italic leading-relaxed">
                  &ldquo;{t.quote}&rdquo;
                </p>
                <div className="mt-auto">
                  <p className="font-sans text-sm font-bold text-warm-brown dark:text-cream">{t.name}</p>
                  <p className="font-sans text-xs text-warm-light dark:text-[#D48090]">{t.role}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Scripture footer */}
      <section className="bg-cream dark:bg-[#140A0E] py-14 px-4 text-center transition-colors duration-300">
        <blockquote className="max-w-2xl mx-auto text-center border-t-2 border-rose/30 pt-6">
          <p className="font-serif text-xl text-warm-muted dark:text-[#E8A0B0] italic leading-relaxed">
